 ...
 */
export function init_starfield(canvas_id) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.init_starfield(ptr0, len0);
}

export function start_starfield() {
    wasm.start_starfield();
}

export function stop_starfield() {
    wasm.stop_starfield();
}
 ...
 * @param {number} param3
 */
export function update_starfield_params(param1, param2, param3) {
    wasm.update_starfield_params(param1, param2, param3);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('starfield_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
